...
function setUserResponse(message) {
  const user_response = `<img class="userAvatar" src='./khwopaChat/static/img/userAvatar.jpg'><div class="userMsg">${message} </div><div class="clearfix"></div>`;
...
function displayInitialUserMessage() {
  ...
  BotResponse = `<img class="botAvatar" src="./khwopaChat/static/img/sara_avatar.png"/><div class="botMsg">${welcomeMessage}</div><div class="clearfix"></div>`;
...
function getBotResponse(text) {
  botResponse = `<img class="botAvatar" src="./khwopaChat/static/img/sara_avatar.png"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
  return botResponse;
}
...
function setBotResponse(response) {
  ...
  setTimeout(() => {
    ...
    if (response.length < 1) {
      ...
      const BotResponse = `<img class="botAvatar" src="./khwopaChat/static/img/sara_avatar.png"/><div class="botMsg">${fallbackMsg}</div><div class="clearfix"></div>`;
        ...
        if (Object.hasOwnProperty.call(response[i], "text")) {
          if (response[i].text != null) {
            ...
            if (
              ...
              html = html.replaceAll("<br>", "");
              // botResponse = `<img class="botAvatar" src="./khwopaChat/static/img/sara_avatar.png"/><span class="botMsg">${html}</span><div class="clearfix"></div>`;
              botResponse = getBotResponse(html);
            } else {
              // if no markdown formatting found, render the text as it is.
              if (!botResponse) {
                botResponse = `<img class="botAvatar" src="./khwopaChat/static/img/sara_avatar.png"/><div class="botMsg">${response[i].text}</div><div class="clearfix"></div>`;
              }
            }
